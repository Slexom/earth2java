...
import net.minecraft.client.render.tileentity.ItemStackTileEntityRenderer;
...
public class RainbowBedItemStackTileEntityRenderer extends ItemStackTileEntityRenderer {
    @Override
    public void render(ItemStack itemstack, MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int combinedLightIn, int combinedOverlayIn) {
