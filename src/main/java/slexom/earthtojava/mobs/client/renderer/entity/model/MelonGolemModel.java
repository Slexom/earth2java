...
public class MelonGolemModel <T extends Entity> extends SegmentedModel<T> {
    ...
    public MelonGolemModel() {
        this.head = (new ModelRenderer(this, 0, 0)).setTextureSize(128, 64);
        this.head.addBox(-8.0F, -16.0F, -8.0F, 16.0F, 16.0F, 16.0F, -0.5F);
        this.head.setRotationPoint(0.0F, 4.0F, 0.0F);
        this.rightHand = (new ModelRenderer(this, 64, 0)).setTextureSize(128, 64);
        this.rightHand.addBox(-1.0F, 0.0F, -1.0F, 12.0F, 2.0F, 2.0F, -0.5F);
        this.rightHand.setRotationPoint(0.0F, 6.0F, 0.0F);
        this.leftHand = (new ModelRenderer(this, 64, 0)).setTextureSize(128, 64);
        this.leftHand.addBox(-1.0F, 0.0F, -1.0F, 12.0F, 2.0F, 2.0F, -0.5F);
        this.leftHand.setRotationPoint(0.0F, 6.0F, 0.0F);
        this.body = (new ModelRenderer(this, 0, 32)).setTextureSize(128, 64);
        this.body.addBox(-5.0F, -10.0F, -5.0F, 10.0F, 10.0F, 10.0F, -0.5F);
        this.body.setRotationPoint(0.0F, 13.0F, 0.0F);
        this.bottomBody = (new ModelRenderer(this, 64, 32)).setTextureSize(128, 64);
