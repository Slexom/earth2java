...
public class ItemInit {
    ...
    public static final int JUMBO_RABBIT_EGG_SECONDARY_COLOR = 0xf7d1c0;
    public static final RegistryObject<ModdedSpawnEggItem> JUMBO_RABBIT_SPAWN_EGG = registerSpawnEgg(EntityTypesInit.JUMBO_RABBIT_REGISTRY_NAME, EntityTypesInit.JUMBO_RABBIT_REGISTRY_OBJECT, JUMBO_RABBIT_EGG_PRIMARY_COLOR, JUMBO_RABBIT_EGG_SECONDARY_COLOR);
