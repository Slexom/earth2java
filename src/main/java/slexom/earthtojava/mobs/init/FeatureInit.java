...
public class FeatureInit {
    ...
    public static void init() {
        E2J_FLOWERS_CONFIGURED_FEATURE = RegisterHelper.registerConfiguredFeature("e2j_flowers", Feature.FLOWER, FeatureInit.createRandomPatchFeatureConfig(new WeightedBlockStateProvider(new DataPool.Builder<BlockState>().add(BlockInit.PINK_DAISY.getDefaultState(), 1).add(BlockInit.BUTTERCUP.getDefaultState(), 1)), 64));
