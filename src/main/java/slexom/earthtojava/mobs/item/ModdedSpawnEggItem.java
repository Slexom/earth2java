...
public class ModdedSpawnEggItem extends SpawnEggItem {
    ...
    public ModdedSpawnEggItem(final NonNullSupplier<? extends EntityType<?>> entityTypeSupplier, final int primaryColor, final int secondaryColor, final Properties p_i48465_4_) {
        super(null, primaryColor, secondaryColor, p_i48465_4_);
        this.entityTypeSupplier = Lazy.of(entityTypeSupplier::get);
        UNADDED_EGGS.add(this);
    }

    public ModdedSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColor, final int secondaryColor, final Properties p_i48465_4_) {
        super(null, primaryColor, secondaryColor, p_i48465_4_);
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        if (E2JModConfig.showDescription) {
            tooltip.add(this.getEggDescription().applyTextStyle(TextFormatting.GRAY));
        }
    }

    @OnlyIn(Dist.CLIENT)
    public ITextComponent getEggDescription() {
