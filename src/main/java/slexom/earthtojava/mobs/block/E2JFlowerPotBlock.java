...
//
//    private final Map<net.minecraft.util.Identifier, Supplier<? extends Block>> fullPots;
//    private final Supplier<E2JFlowerPotBlock> emptyPot;
//    private final Supplier<? extends Block> flowerDelegate;
//
//    public E2JFlowerPotBlock(Block content, AbstractBlock.Settings settings) {
//        super(properties);
//        this.content = blockIn.get();
...
//        return this.content == Blocks.AIR ? super.getItem(worldIn, pos, state) : new ItemStack(this.content);
//    }
//
//    /**
...
//    }
//
//    public void addPlant(net.minecraft.util.Identifier flower, Supplier<? extends Block> fullPot) {
//        if (getEmptyPot() != this) {
