        ...
        DeferredWorkQueue.runLater(new Runnable() {
            ...
            public void run() {
                for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
                    ...
                    }.withConfiguration(new BlockStateFeatureConfig(BlockInit.MUD_BLOCK.get().getDefaultState())).withPlacement(Placement.WATER_LAKE.configure(new ChanceConfig(40))));
                }
            }
        });
    }
