...
public class PiebaldPigEntity extends EarthtojavamobsModElements.ModElement {
    ...
    public void registerModels(ModelRegistryEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new PigRenderer(renderManager) {
            private final ResourceLocation texture = new ResourceLocation("earthtojavamobs:textures/mobs/pig/piebald_pig/piebald_pig.png");
            private final ResourceLocation textureBlink = new ResourceLocation("earthtojavamobs:textures/mobs/pig/piebald_pig/piebald_pig_blink.png");
