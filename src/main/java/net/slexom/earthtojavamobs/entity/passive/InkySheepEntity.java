...
public class InkySheepEntity extends OneColorSheepEntity<InkySheepEntity> {
...
//
//    private static final DataParameter<Byte> isSheared = EntityDataManager.createKey(InkySheepEntity.class, DataSerializers.BYTE);
//
//    private int sheepTimer;
//    private EatGrassGoal eatGrassGoal;
//
//    public InkySheepEntity(EntityType<? extends InkySheepEntity> type, World world) {
//        super(type, world);
//        experienceValue = 2;
//        setNoAI(false);
//    }
...
//
//    @Override
//    public InkySheepEntity createChild(AgeableEntity ageable) {
//        return (InkySheepEntity) getType().create(this.world);
//    }
//
