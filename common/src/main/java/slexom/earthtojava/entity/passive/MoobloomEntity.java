...
public class MoobloomEntity extends E2JBaseCowEntity implements Shearable {
	...
	protected void initGoals() {
		super.initGoals();
		goalSelector.add(8, new MoobloomPlaceBlockGoal(this));
	}
	...
	public void sheared(SoundCategory shearedSoundCategory) {
		...
		for (int i = 0; i < 5; ++i) {
			getWorld().spawnEntity(new ItemEntity(getWorld(), getX(), getBodyY(1.0D), getZ(), new ItemStack(BlockInit.BUTTERCUP.get())));
		}
