...
public class FeatureInit {
    ...
    public static void init() {
        ...
        MUD_LAKE_CONFIGURED_FEATURE = RegisterHelper.registerConfiguredFeature("lake_mud", Feature.LAKE, new LakeFeature.Config(BlockStateProvider.of(BlockInit.MUD_BLOCK.get().getDefaultState()), BlockStateProvider.of(Blocks.DIRT.getDefaultState())));
