...
public final class SoundEventsInit {
	...
	public static final String BONE_SPIDER_AMBIENT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.BONE_SPIDER_REGISTRY_NAME, "ambient");
	public static final String BONE_SPIDER_BONE_STAB_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.BONE_SPIDER_REGISTRY_NAME, "bone.stab");
	public static final String BONE_SPIDER_DEATH_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.BONE_SPIDER_REGISTRY_NAME, "death");
	public static final String BONE_SPIDER_SPIT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.BONE_SPIDER_REGISTRY_NAME, "spit");
	public static final String BONE_SPIDER_WALK_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.BONE_SPIDER_REGISTRY_NAME, "walk");
	public static final String CLUCKSHROOM_LAY_MUSHROOM_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.CLUCKSHROOM_REGISTRY_NAME, "lay_mushroom");
	public static final String FANCY_CHICKEN_AMBIENT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.FANCY_CHICKEN_REGISTRY_NAME, "ambient");
	public static final String FANCY_CHICKEN_DEATH_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.FANCY_CHICKEN_REGISTRY_NAME, "death");
	public static final String FANCY_CHICKEN_FLEE_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.FANCY_CHICKEN_REGISTRY_NAME, "flee");
	public static final String FANCY_CHICKEN_HURT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.FANCY_CHICKEN_REGISTRY_NAME, "hurt");
	public static final String FURNACE_GOLEM_AGGRO_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.FURNACE_GOLEM_REGISTRY_NAME, "aggro");
	public static final String FURNACE_GOLEM_ATTACK_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.FURNACE_GOLEM_REGISTRY_NAME, "attack");
	public static final String JOLLY_LLAMA_BELL_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.JOLLY_LLAMA_REGISTRY_NAME, "bell");
	public static final String JOLLY_LLAMA_DETECT_FERN_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.JOLLY_LLAMA_REGISTRY_NAME, "detect_fern");
	public static final String JOLLY_LLAMA_EAT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.JOLLY_LLAMA_REGISTRY_NAME, "eat");
	public static final String JOLLY_LLAMA_PRANCE_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.JOLLY_LLAMA_REGISTRY_NAME, "prance");
	public static final String JUMBO_RABBIT_AMBIENT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.JUMBO_RABBIT_REGISTRY_NAME, "ambient");
	public static final String JUMBO_RABBIT_HURT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.JUMBO_RABBIT_REGISTRY_NAME, "hurt");
	public static final String JUMBO_RABBIT_JUMP_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.JUMBO_RABBIT_REGISTRY_NAME, "jump");
	public static final String LOBBER_ZOMBIE_ATTACK_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.LOBBER_ZOMBIE_REGISTRY_NAME, "attack");
	public static final String LOBBER_ZOMBIE_ROTTEN_FLESH_HIT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.LOBBER_ZOMBIE_REGISTRY_NAME, "rotten_flesh.hit");
	public static final String MELON_GOLEM_AGGRO_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.MELON_GOLEM_REGISTRY_NAME, "aggro");
	public static final String MELON_GOLEM_ATTACK_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.MELON_GOLEM_REGISTRY_NAME, "attack");
	public static final String MELON_GOLEM_CHARGE_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.MELON_GOLEM_REGISTRY_NAME, "charge");
	public static final String MELON_GOLEM_SEED_HIT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.MELON_GOLEM_REGISTRY_NAME, "seed.hit");
	public static final String MOOBLOOM_PLANT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.MOOBLOOM_REGISTRY_NAME, "plant");
	public static final String MOOLIP_PLANT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.MOOLIP_REGISTRY_NAME, "plant");
	public static final String RAINBOW_SHEEP_AMBIENT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.RAINBOW_SHEEP_REGISTRY_NAME, "ambient");
	public static final String RAINBOW_SHEEP_DEATH_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.RAINBOW_SHEEP_REGISTRY_NAME, "death");
	public static final String SKELETON_WOLF_AMBIENT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.SKELETON_WOLF_REGISTRY_NAME, "ambient");
	public static final String SKELETON_WOLF_DEATH_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.SKELETON_WOLF_REGISTRY_NAME, "death");
	public static final String SKELETON_WOLF_GROWL_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.SKELETON_WOLF_REGISTRY_NAME, "growl");
	public static final String SKELETON_WOLF_HOWL_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.SKELETON_WOLF_REGISTRY_NAME, "howl");
	public static final String SKELETON_WOLF_HURT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.SKELETON_WOLF_REGISTRY_NAME, "hurt");
	public static final String SKELETON_WOLF_PANT_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.SKELETON_WOLF_REGISTRY_NAME, "pant");
	public static final String SKELETON_WOLF_SHAKE_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.SKELETON_WOLF_REGISTRY_NAME, "shake");
	public static final String SKELETON_WOLF_STEP_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.SKELETON_WOLF_REGISTRY_NAME, "step");
	public static final String SKELETON_WOLF_WHINE_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.SKELETON_WOLF_REGISTRY_NAME, "whine");
	public static final String VILER_WITCH_CASTING_REGISTRY_NAME = getEntitySoundEventName(RegistryNames.VILER_WITCH_REGISTRY_NAME, "casting");
