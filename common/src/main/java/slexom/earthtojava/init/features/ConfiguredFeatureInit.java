...
public class ConfiguredFeatureInit {
    private static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURE_DEFERRED_REGISTER = DeferredRegister.create(Earth2JavaMod.MOD_ID, Registry.CONFIGURED_FEATURE_KEY);
    ...
    public static void init() {
        CONFIGURED_FEATURE_DEFERRED_REGISTER.register();
    }
    ...
    public static <FC extends FeatureConfig, F extends Feature<FC>> RegistrySupplier<ConfiguredFeature<FC, F>> registerConfiguredFeature(String registryName, F feature, FC config) {
        return CONFIGURED_FEATURE_DEFERRED_REGISTER.register(registryName, () -> new ConfiguredFeature<>(feature, config));
    }
