...
public class SootyPigRenderer extends MobEntityRenderer<E2JBasePigEntity, SootyPigModel> {
	...
	public Identifier getTexture(E2JBasePigEntity entity) {
		Identifier texture = TextureUtils.getTextureIdentifier("pig", RegistryNames.SOOTY_PIG_REGISTRY_NAME);
		Identifier textureBlink = TextureUtils.getTextureIdentifier("pig", RegistryNames.SOOTY_PIG_REGISTRY_NAME, "blink");
